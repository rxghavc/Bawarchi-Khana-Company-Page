...
export const reviews: Review[] = [
  ...
  { rating: 4, quote: "Authentic taste, generous portions.", name: "Fatima", location: "Hounslow" },
  { rating: 5, quote: "So good, we ordered again the next day!", name: "Imran", location: "Windsor" },
  { rating: 4, quote: "Fragrant rice and tender meat, truly amazing.", name: "Sara", location: "Maidenhead" },
